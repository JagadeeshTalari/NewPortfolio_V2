  ...
  return (
    <div className='selfIntro'>
      <div>
        ...
        <div className='bg-black__box'>
          <a href="https://drive.google.com/file/d/1fRtz77sPsgck5PqAspDUdBM9xr9kIXHO/view?usp=drive_link" target="_blank">
        ...
        <div className='connect'>
          ...
          <div className='social-links'>
            <a href="mailto:talarijagadeesh55@gmail.com" target="_blank"><img src={mail} alt="mail" className='BlackIcon'/></a>
            <a href="https://www.linkedin.com/in/jagadeesh-talari-1a1396187/" target="_blank"><img src={linkedIn} alt="linkedIn" className='WhiteIcon'/></a>
            <a href="https://github.com/JagadeeshTalari" target="_blank"><img src={github} className='BlackIcon' alt="github"/></a>
