    ...
    <div id="workHistory">
      ...
      <div className="workHistorLine">
        ...
        <div className="workDetails">
          <p className="companyName">Aapmor Technologies</p>
          <p className="role">SDE II (Full Time)</p>
          <p className="duration">Feb 2024 - present</p>
        </div>
        <Circles />
        <div className="workDetails">
        ...
        <div className="workDetails">
          ...
          <p className="duration">Apr 2021 - July 2021</p>
        </div> */}
        {/* <Circles /> */}
